...
const AdminUser = () => {
    ...
    const mutation = useMutationHooks(
        (data) =>{
            ...
            const res = UserService.createUser({name,email, isAdmin,phone})
            return res
        }         
    )
    ...
    return (
        <div>
            ...
            {/* <div style={{marginTop:'10px'}}>
               <Button style={{height:'150px',width:'150px',borderStyle:'dashed'}}><PlusOutlined style={{fontSize:'60px'}} /> </Button>
            </div> */}
            <div style={{marginTop:'20px'}}>
            <TableComponent handleDeleteMany={handleDeleteManyUsers} columns={columns} data={dataTable} isLoading={isLoadingUser} onRow={(record, rowIndex)=>{
                return{
                    onClick: event=>{
        ...
        <DrawerComponent title='Chi tiết nguời  dùng' isOpen={isOpenDrawer} onClose={() => setIsOpenDrawer(false)} width="50%">
