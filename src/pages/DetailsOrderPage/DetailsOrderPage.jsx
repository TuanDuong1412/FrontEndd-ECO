  ...
  return (
   <Loading isLoading={isLoading}>
     <div style={{width: '100%', background: '#f5f5fa'}}>
      <div style={{ width: '1270px', margin: '0 auto', height: '1270px',padding:'10px'}}>
      <h3 style={{ fontWeight: "bold" , marginTop:'0px'}}>Chi tiết đơn hàng</h3>
        <WrapperHeaderUser>
          <WrapperInfoUser>
        ...
        <WrapperStyleContent>
          <div style={{flex:1,display: 'flex', alignItems: 'center',gap:'10px',borderRight:'1px solid'}}>
          

            <div style={{width: '150px',borderRight:'1px solid'}}>Sản phẩm</div>
            <WrapperItemLabel>Tên</WrapperItemLabel>
          ...
          {data?.orderItems?.map((order) => {
            return (
              <WrapperProduct >
                ...
                <WrapperItem style={{marginLeft:'10px'}}>{order?.name}</WrapperItem>
